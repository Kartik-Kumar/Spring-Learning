...
public class LoggerAspect {
    ...
    @Around("execution(* com.assignment.services.*.*(..))")
    ...
    @Around("@annotation(com.assignment.interfaces.LogAspect)")
    ...
    @AfterThrowing(value = "execution(* com.assignment.services.*.*(..))",throwing = "ex")
    ...
    @AfterReturning(value = "execution(* com.assignment.services.*.*(..))",returning = "retVal")
